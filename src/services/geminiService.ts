  ...
  try {
    const response = await ai.models.generateContent({
      ...
      contents: [
        ...
        `Analyzuj tato dvě PDF. První obsahuje otázky, druhé obsahuje správné odpovědi. 
        Extrahuj otázky z prvního PDF. Ke každé otázce vytvoř 4 možnosti (jedna správná z druhého PDF, 3 smysluplné nesprávné, pokud v PDF nejsou). 
        Přiřaď správnou odpověď z druhého PDF. Vrať jako JSON pole otázek. Vše v češtině.`
      ],
      config: {
        responseMimeType: "application/json",
        responseSchema: {
